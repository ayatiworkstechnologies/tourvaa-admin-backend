...
class CustomerCreate(BaseModel):
    ...
    @field_validator("first_name", "last_name", "address", "profile_image", "country", "state", "city", "pincode", "status")
    @classmethod
...
class CustomerUpdate(BaseModel):
    ...
    @field_validator("first_name", "last_name", "full_name", "phone", "address", "profile_image", "country", "state", "city", "pincode")
    @classmethod
    def trim_optional_text(cls, value: Optional[str]):
        if value is None:
            return value
