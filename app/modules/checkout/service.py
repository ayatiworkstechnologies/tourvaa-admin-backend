...
from app.modules.checkout.schemas import CheckoutConfirm, CheckoutStart, CheckoutUpdate
...
def confirm_session(db: Session, session_key: str, body: CheckoutConfirm, current_user: User) -> dict:
    ...
    from app.modules.bookings.schemas import BookingAddonPayload, BookingCreate, BookingTravellerPayload
