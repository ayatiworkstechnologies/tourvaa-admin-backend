    ...
    return {
        ...
        "data": {
            **_public_tour(tour),
            ...
            "optional_activities": [{"id": a.id, "name": a.activity_name, "description": a.description or "", "price": float(a.price_per_person) if a.price_per_person else None, "currency": tour.currency or "AED"} for a in activities],
