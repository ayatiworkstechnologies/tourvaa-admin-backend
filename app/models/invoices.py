...
class Invoice(Base):
    ...
    gst_rate = Column(Numeric(5, 4), default=0.18, nullable=False)
    ...
    balance_reminder_stage = Column(String(20), nullable=True)
    last_balance_reminder_at = Column(DateTime(timezone=True), nullable=True)
