...
def generate_pdf(output_path: Path, invoice_data: dict) -> None:
    ...
    invoice_date, status, currency, subtotal_amount, gst_amount, total_amount,
    amount_paid, amount_due, items=[{description, quantity, unit_price, tax_amount, total_price}]
    """
