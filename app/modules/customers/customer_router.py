...
from app.modules.bookings.service import calculate_booking_price, create_booking, get_booking_detail, get_bookings, serialize_booking
from app.modules.common.auth import get_current_user
from app.modules.common.money import money
from app.modules.common.pagination import pagination_params
from app.modules.customers.models import Customer, CustomerCancellationRequest, CustomerCommunication, CustomerSavedTraveller
...
from app.modules.customers.service import serialize_customer, serialize_communication
from app.modules.invoices.service import list_invoices
from app.modules.payments.schemas import PaymentCreate
from app.modules.payments.service import create_payment, get_customer_payments
from app.modules.users.models import User
from app.security import hash_password, verify_password
from app.modules.profile.schemas import PasswordUpdate
...
def customer_invoice_download(invoice_id: int, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
    ...
    if not invoice:
        ...
        from app.modules.invoices.service import serialize_invoice
